...
export const LEVELS = [
  {
    ...
    palette: { wall: '#3a4434', wall2: '#2c3328', floor: '#1c2418', ceil: '#05060a', prop: '#4a5444', fog: '#060a08', sky: '#04060a' },
    outdoor: true,
  ...
  },
  {
    ...
    palette: { wall: '#2e3a4a', wall2: '#26303c', floor: '#28241c', ceil: '#0a0c10', prop: '#3a4a5e', fog: '#05070a' },
  ...
  },
  {
    ...
    palette: { wall: '#b0a050', wall2: '#988a42', floor: '#7a6e3a', ceil: '#c4b66a', prop: '#8a7c3e', fog: '#5a522a' },
  ...
  },
  {
    ...
    palette: { wall: '#7a4a2c', wall2: '#5e3a22', floor: '#3a2c1e', ceil: '#0a0608', prop: '#c97b2c', fog: '#0a0504', sky: '#0c060a' },
    outdoor: true,
  ...
  },
  {
    ...
    palette: { wall: '#5e4a30', wall2: '#4a3a26', floor: '#3e3422', ceil: '#0c1018', prop: '#7a6a44', fog: '#070806', sky: '#0a0e16' },
    outdoor: true,
  ...
  },
  {
    ...
    palette: { wall: '#6a4434', wall2: '#523428', floor: '#4a2c1c', ceil: '#0a0a12', prop: '#3e5a2e', fog: '#060604', sky: '#080a10' },
    outdoor: true,
  ...
  },
  {
    ...
    palette: { wall: '#5a6066', wall2: '#464c52', floor: '#33373c', ceil: '#16181c', prop: '#7a3030', fog: '#06080a' },
  ...
  },
  {
    ...
    palette: { wall: '#4a3c30', wall2: '#3a3026', floor: '#aab0b8', ceil: '#10141c', prop: '#a02828', fog: '#0c0e12', sky: '#0e1219' },
    outdoor: true,
  ...
  },
  {
    ...
    palette: { wall: '#3c4438', wall2: '#2e362c', floor: '#26221a', ceil: '#0a0e16', prop: '#5a6a5e', fog: '#04070a', sky: '#060a12' },
    outdoor: true,
  ...
  },
  {
    ...
    palette: { wall: '#3a3026', wall2: '#2c241c', floor: '#221c14', ceil: '#080604', prop: '#8c2020', fog: '#040302' },
